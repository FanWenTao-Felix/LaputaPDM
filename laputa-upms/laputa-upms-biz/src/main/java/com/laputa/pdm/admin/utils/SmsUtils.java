package com.laputa.pdm.admin.utils;
...
import com.laputa.pdm.admin.config.SmsProperties;
...
public class SmsUtils {
    ...
    public  SendSmsResponse sendSms(String phone,String code) throws ClientException {
        ...
        SendSmsResponse sendSmsResponse = sendSms(phone,code,properties.getSignName(),properties.getVerifyCodeTemplate());
...
//        IClientProfile profile = DefaultProfile.getProfile("cn-hangzhou", "LTAIQYowl1zz8gzf", "VphoHmcNQF8aaxpa330Re2zJLIgQX0");
